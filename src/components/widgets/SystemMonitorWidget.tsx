  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      try {
        ...
        unsubRef.current = await window.api.system.subscribe(1000, (data) => {
          if (!mounted) return;
    ...
    <div className="h-full overflow-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatPercentage(cpuLoad)}</div>
            <div className="mt-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatPercentage(memPercent)}</div>
            <div className="mt-4">
              <div className="h-2 bg-secondary rounded-full overflow-hidden">
                <div
